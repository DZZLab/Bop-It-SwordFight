...
CapacitiveSensor TouchSensor = CapacitiveSensor(2, 3);///2 send
...
void displayCountdownBar(unsigned long elapsedTime, unsigned long totalTime) {
  ...
  //   leds[j] = CRGB((255 / NUM_LEDS) * j, 0, (255 / NUM_LEDS) * j);
  //   FastLED.show();
  // }
  // // Set the rest of the strip to off
  // for (int k = ledLength + 1; k < NUM_LEDS; k++) {
  //   leds[k] = CRGB::Black;
  //   FastLED.show();
  // }
}
